...
case class BasicAuth(username: String, password: String, appToken: String, headers:List[Pair[String,String]] = List.empty[Pair[String,String]]) extends Authorization
